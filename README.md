...
├── images/                        # site assets
├── homework/
│   ├── homework-1/                # dataset & preprocessing
│   │   ├── mmai_HW1.ipynb
│   │   ├── mmai_HW1_writeup.pdf
│   │   ├── thoughts.txt
│   │   └── README.md
│   ├── homework-2/                # fusion & alignment
│   │   ├── mmai_HW2.ipynb
│   │   ├── mmai_HW2_writeup.pdf
│   │   ├── thoughts.txt
│   │   └── README.md
│   └── ...
...
For my final project, I built with Xander Backus, a multimodal AI assistant that helps visually impaired users understand their physical environment through natural language, using egocentric video as input. See `final-project/README.md` and the [project repo](https://github.com/juliavekim/EgoBlind-RA/tree/main). 
